...
Written by Štěpán Davidovič[114](#id-WakuESLFd)
...
conjunction with a datacenter scheduling system like Borg [[Ver15]](/sre-book/bibliography#Ver15).
...
Despite this change, the load caused by the cron jobs is still very spiky. The graph in [Figure 24-3](#fig_reliable_cron_job_launches) illustrates the aggregate global number of launches of cron jobs at Google. This
...
[114](#id-WakuESLFd-marker)This chapter was previously published in part in *ACM Queue* (March 2015, vol. 13, issue 3).

[115](#id-z0AIxSrSnSWIVtOTJ-marker)Failure of individual jobs is beyond the scope of this analysis.
