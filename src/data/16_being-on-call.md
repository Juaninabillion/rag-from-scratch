...
Written by Andrea Spadaccini[56](#id-mX2uoSyFW)  
...
[56](#id-mX2uoSyFW-marker)An earlier version of this chapter appeared as an article in *;login:* (October 2015, vol. 40, no. 5).

[57](#id-D04I1SVigIauO-marker)For more discussion on the natural tension between SRE and product development teams, see [Introduction](/sre-book/introduction/).
...
Chapter 12 - Effective Troubleshooting](/sre-book/effective-troubleshooting/)
