...
Once those involved are satisfied with the document and its action items, the postmortem is added to a team or organization repository of past incidents.[81](#id-4DBuqSVu9iy) Transparent sharing makes it easier for others to find and learn from the postmortem.
...
[80](#id-D04I1SPc1iK-marker)See [*https://www.google.com/policies/privacy/*](https://www.google.com/policies/privacy/).

[81](#id-4DBuqSVu9iy-marker)If you’d like to start your own repository, Etsy has released [*Morgue*](https://github.com/etsy/morgue), a tool for managing postmortems.

[82](#id-JJ7umIlF2Tyuq-marker)Google’s Peer Bonus program is a way for fellow Googlers to recognize colleagues for exceptional efforts and involves a token cash reward.

[83](#id-9vbuDtvF7TXuQ-marker)For further discussion of this particular incident, see [Emergency Response](/sre-book/emergency-response/).

[Previous

Chapter 14 - Managing Incidents](/sre-book/managing-incidents/)
