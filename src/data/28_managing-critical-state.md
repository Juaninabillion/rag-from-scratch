...
[112](#id-Xe4u4ioHA-marker)Kyle Kingsbury has written an extensive series of articles on distributed systems correctness, which contain many examples of unexpected and incorrect behavior in these kinds of datastores. See [*https://aphyr.com/tags/jepsen*](https://aphyr.com/tags/jepsen).

[113](#id-jE2uxSEIwhM-marker)In particular, the performance of the original Paxos algorithm is not ideal, but has been greatly improved over the years.

[Previous

Chapter 22 - Addressing Cascading Failures](/sre-book/addressing-cascading-failures/)
