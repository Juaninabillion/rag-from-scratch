...
**Action Items**:[165](#id-lM2ulFwsKD)
...
**Where we got lucky[166](#id-mX2uoSWSotMfzG)**
...
## Supporting information:[168](#id-8ZQumS0SqFvo)
...
[163](#id-gA2uwFdcDB-marker)Impact is the effect on users, revenue, etc.

[164](#id-YAJuMt7iQW-marker)An explanation of the circumstances in which this incident happened. It’s often helpful to use a technique such as the 5 Whys [[Ohn88]](/sre-book/bibliography#Ohn88) to understand the contributing factors.

[165](#id-lM2ulFwsKD-marker)"Knee-jerk" AIs often turn out to be too extreme or costly to implement, and judgment may be needed to re-scope them in a larger context. There’s a risk of over-optimizing for a particular issue, such as adding specific monitoring/alerting when reliable mechanisms like unit tests can catch problems much earlier in the development process.

[166](#id-mX2uoSWSotMfzG-marker)This section is really for near misses, e.g., “The goat teleporter was available for emergency use with other animals despite lack of certification.”

[167](#id-N1KFnSNSAS9a-marker)A “screenplay” of the incident; use the incident timeline from the Incident Management document to start filling in the postmortem’s timeline, then supplement with other relevant entries.

[168](#id-8ZQumS0SqFvo-marker)Useful information, links, logs, screenshots, graphs, IRC logs, IM logs, etc.
