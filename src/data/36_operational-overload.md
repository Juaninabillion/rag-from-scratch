...
:   To give acceptable on-call support for a component, you should at least know the consequences when it breaks and the
    urgency needed to fix problems.
...
postvitam,[145](#id-p8BuzSWtjs2) explaining the critical decisions at each step that led to success.
...
[145](#id-p8BuzSWtjs2-marker)In contrast to a postmortem.
