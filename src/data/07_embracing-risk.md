...
# Motivation for Error Budgets[14](#id-na2u1S2SKi1)
...
[14](#id-na2u1S2SKi1-marker)An early version of this section appeared as an article in *;login:* (August 2015, vol. 40, no. 4).

[15](#id-bb2umSeIPu8iV-marker)Known as "bang/bang" control—see [*https://en.wikipedia.org/wiki/Bang–bang\_control*](https://en.wikipedia.org/wiki/Bang–bang_control).
