...
What exactly is the value of automation?[26](#id-dA2ubFyF9TY)
...
Automation doesn’t just provide consistency. Designed and done properly, automatic systems also provide a *platform* that can be extended, applied to more systems, or perhaps even spun out for profit.[27](#id-7pEuOFgFdt4Tz) (The alternative, no automation, is neither cost effective nor extensible: it is instead a tax levied on the operation of a system.)
...
[26](#id-dA2ubFyF9TY-marker)For readers who already feel they precisely understand the value of automation, skip ahead to [The Value for Google SRE](#xref_automation_value). However, note that our description contains some nuances that might be useful to keep in mind while reading the rest of the chapter.

[27](#id-7pEuOFgFdt4Tz-marker)The expertise acquired in building such automation is also valuable in itself; engineers both deeply understand the existing processes they have automated and can later automate novel processes more quickly.

[28](#id-QQLukSXFDcMTj-marker)See the following XKCD cartoon: [*https://xkcd.com/1205/*](https://xkcd.com/1205/).

[29](#id-BWDuNFjFxcV-marker)See, for example, [*https://blog.engineyard.com/2014/pets-vs-cattle*](https://blog.engineyard.com/2014/pets-vs-cattle).

[30](#id-0vYuXSLhBTYiK-marker)Of course, not every system that needs to be managed actually provides callable APIs for management—forcing some tooling to use, e.g., CLI invocations or automated website clicks.

[31](#id-bb2urI2FkCQ-marker)We have compressed and simplified this history to aid understanding.

[32](#id-LvQu7SviNCl-marker)As in a small, unchanging number.

[33](#id-bb2ugF2FVsQ-marker)See, e.g., [*https://en.wikipedia.org/wiki/Air\_France\_Flight\_447*](https://en.wikipedia.org/wiki/Air_France_Flight_447).

[34](#id-KpEu9IeF7s2-marker)See, e.g., [[Bai83]](/sre-book/bibliography#Bai83) and [[Sar97]](/sre-book/bibliography#Sar97).

[35](#id-LvQuZTGFbsl-marker)This is yet another good reason for regular practice drills; see [Disaster Role Playing](/sre-book/accelerating-sre-on-call#xref_training_disaster-rpg).

[Previous

Chapter 6 - Monitoring Distributed Systems](/sre-book/monitoring-distributed-systems/)

[Next

Chapter 8 - Release Engineering](/sre-book/release-engineering/)
